...
import { privateOnlineClassDetailsAction } from "../store/class-details/online-classes/class-details-actions";
import ClassDetails from "./../components/class-details/class-details";

function PrivateOnlineClassDetails({ match }) {
  ...
  useEffect(() => {
    dispatch(privateOnlineClassDetailsAction(match.params.id));
  }, [dispatch, match]);
...
export default PrivateOnlineClassDetails;
